...
public class ExtentReportGenerator implements ITestListener{
	...
	public void onStart(ITestContext context) {
		...
		sparkReporter=new ExtentSparkReporter(System.getProperty("user.dir")+ "/Reports/ExtentReport3.html");//specify location of the report
		...
		extent.setSystemInfo("Tester Name","Lokesh");
	...
	public void onFinish(ITestContext context) {//manadatory
